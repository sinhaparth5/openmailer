...
public interface CampaignClickRepository extends JpaRepository<CampaignClick, Long> {
  ...
  List<CampaignClick> findByCampaignId(@Param("campaignId") Long campaignId);
   ...
   */
  @Query("SELECT c FROM CampaignClick c WHERE c.campaign.id = :campaignId")
  Page<CampaignClick> findByCampaignId(@Param("campaignId") Long campaignId, Pageable pageable);
  ...
  List<CampaignClick> findByRecipientId(@Param("recipientId") Long recipientId);
  ...
  List<CampaignClick> findByLinkId(@Param("linkId") Long linkId);
   ...
   */
  @Query("SELECT c FROM CampaignClick c WHERE c.link.id = :linkId")
  Page<CampaignClick> findByLinkId(@Param("linkId") Long linkId, Pageable pageable);
  ...
  Page<CampaignClick> findByDateRange(@Param("campaignId") Long campaignId, @Param("startDate") LocalDateTime startDate, @Param("endDate") LocalDateTime endDate, Pageable pageable);
  ...
  long countUniqueClickersByCampaignId(@Param("campaignId") Long campaignId);
  ...
  long countUniqueClickersByLinkId(@Param("linkId") Long linkId);
  ...
  boolean existsByRecipientIdAndLinkId(@Param("recipientId") Long recipientId, @Param("linkId") Long linkId);
