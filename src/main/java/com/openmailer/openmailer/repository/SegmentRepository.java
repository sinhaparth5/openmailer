...
public interface SegmentRepository extends JpaRepository<Segment, String> {
  ...
  List<Segment> findByUserId(@Param("userId") String userId);
   ...
   */
  @Query("SELECT s FROM Segment s WHERE s.user.id = :userId")
  Page<Segment> findByUserId(@Param("userId") String userId, Pageable pageable);
  ...
  Optional<Segment> findByIdAndUserId(@Param("id") String id, @Param("userId") String userId);
  ...
  Optional<Segment> findByNameAndUserId(@Param("name") String name, @Param("userId") String userId);
  ...
  Page<Segment> findByUserIdAndIsDynamic(@Param("userId") String userId, @Param("isDynamic") Boolean isDynamic, Pageable pageable);
  ...
  List<Segment> findByContactListId(@Param("listId") String listId);
  ...
  Page<Segment> findByUserIdAndNameContainingIgnoreCase(@Param("userId") String userId, @Param("name") String name, Pageable pageable);
  ...
  void deleteByContactListId(@Param("listId") String listId);
}
